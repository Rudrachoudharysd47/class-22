...
function makeRay()
{
   ...
   raysGroup.overlap(g_house,temprature_raise);
...
//Create function for charge1, charge2 & temp_rise
 ...
 function charge1(spra) {
   spra.remove()
   obsorbed1=obsorbed1+1
 }
 function charge2(spra) {
     spra.destroy()
     obsorbed2=obsorbed2+1
 }
 function temprature_raise(spra) {
    spra.remove()
    temp=temp+1
 }
